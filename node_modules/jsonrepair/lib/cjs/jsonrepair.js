...
function jsonrepair(text) {
  ...
  function parseString() {
    ...
    if ((0, _stringUtils.isQuote)(text.charCodeAt(i))) {
      ...
      const isEndQuote = (0, _stringUtils.isDoubleQuote)(text.charCodeAt(i)) ? _stringUtils.isDoubleQuote : (0, _stringUtils.isSingleQuote)(text.charCodeAt(i)) ? _stringUtils.isSingleQuote // eslint-disable-line indent
      : (0, _stringUtils.isSingleQuoteLike)(text.charCodeAt(i)) // eslint-disable-line indent
